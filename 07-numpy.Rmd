...
Navadnen seznam pretvorimo v Numpy seznam s funkcijo `array(seznam)`.
...
Sezname lahko združimo s `np.concatenate(sez1, sez2)`, ki vrne staknjen seznam.
...
vsak element v tabeli izračuna s klicom funkcije `funkcija`; funkcija mora sprejeti toliko argumentov, kolikor je dimenzij
