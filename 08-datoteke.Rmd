...
Primer branja iz datoteke z vaj: [temp.txt](https://r2.rokuk.org/python/temp.txt) (Vir: ARSO), [temp.csv](https://r2.rokuk.org/python/temp.csv) (Vir: ARSO), [temp.py](https://r2.rokuk.org/python/temp.py)
