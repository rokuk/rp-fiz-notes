...
Primer branja iz datoteke z vaj: [temp.txt](https://storage.rokuk.org/python/temp.txt) (Vir: ARSO), [temp.csv](https://storage.rokuk.org/python/temp.csv) (Vir: ARSO), [temp.py](https://storage.rokuk.org/python/temp.py)

## Datotečni sistem

Datoteke so shranjene na različnih nosilcih (npr. trdi disk, SSD, DVD, USB ključ, ...). Prostor, ki je na voljo na nosilcu lahko razdelimo 
...
Za delo z datotečnim sistemom je na voljo modul `os`.
