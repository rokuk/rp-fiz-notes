...
\item
  ...
  dodamo v LaTeX dokument z \texttt{\textbackslash{}input\{pot.pgf\}}.
...
\item
  ...
  klicem funkcije \texttt{plt.savefig(pot.png,\ dpi=300)}. Parameter \texttt{dpi} (dots per inch) dolča resolucijo slike. Sliko nato
