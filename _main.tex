...
\fi
\babelprovide[main,import]{slovene}
...
\tightlist
\item
  Sliko shranimo v vektorskem formatu \texttt{.pgf}. To lahko naredimo s klicem funkcije \texttt{plt.savefig(pot.pgf)}. Sliko nato dodamo v LaTeX dokument z \texttt{\textbackslash{}input\{pot.pgf\}}, pred tem pa na začetku datoteke uvozimo \texttt{\textbackslash{}usepackage\{pgf\}}. Prednost vektorske slike je, da slika ohrani ostrino ne glede na to, koliko povečana je, in da so fonti številk in oznak na sliki enaki kot v LaTeXu ter prave velikosti. Da se tudi nastaviti, da je širina slike npr. ravno polovico širine dokumenta. Vse skupaj je opisano tu: \url{https://timodenk.com/blog/exporting-matplotlib-plots-to-latex} Za grafe z veliko točkami (\textgreater1000) pa je bolje uporabiti \texttt{.png}, sicer je stavljenje dokumenta z LaTeXom lahko zelo počasno.
\item
  Sliko shranimo v rastrskem formatu \texttt{.png}. To lahko naredimo s klicem funkcije \texttt{plt.savefig(pot.png,\ dpi=300)}. Parameter \texttt{dpi} (dots per inch) dolča resolucijo slike. Ponavadi zadošča 300. Sliko nato dodamo v LaTeX dokument z \texttt{\textbackslash{}includegraphics\{pot.png\}}. Privzeto fonti ne bodo taki kot v LaTeXu, kar ni najlepše. Prave fonte lahko nastavimo z
\end{enumerate}
...
Obširen tečaj računalništva. Vzame nekaj ur, priporočam predvsem prvih 21 videov. \url{https://www.youtube.com/watch?v=tpIctyqH29Q\&list=PLH2l6uzC4UEW0s7-KewFLBC1D0l6XRfye\&index=1}
