...
Izvorna koda za strani je dostopna na \url{https://github.com/rokuk/rp-fiz-notes}
...
\begin{quote}
Če ste na Windowsu in ukaz \texttt{python\ -\/-version} ne izpiše verzije, temveč se vam izpiše napaka ali ``Python not found'', poskusite ukaz \texttt{py\ -\/-version}.
\end{quote}
