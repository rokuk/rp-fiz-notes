...
Ko v zanki potrebujemo indekse, pride prav pristop, kjer do elementov seznama dostopamo z indeksi.
...
\tightlist
\item
  Sliko shranimo v vektorskem formatu \texttt{.pgf}. To lahko naredimo s klicem funkcije \texttt{plt.savefig(pot.pgf)}. Sliko nato dodamo v LaTeX dokument z \texttt{\textbackslash{}input\{pot.pgf\}}, znotraj okolja \texttt{figure} pred tem pa na začetku datoteke uvozimo \texttt{\textbackslash{}usepackage\{pgf\}}. Prednost vektorske slike je, da slika ohrani ostrino ne glede na to, koliko povečana je, in da so fonti številk in oznak na sliki enaki kot v LaTeXu ter prave velikosti. Da se tudi nastaviti, da je širina slike npr. ravno polovico širine dokumenta. Vse skupaj je opisano tu: \url{https://timodenk.com/blog/exporting-matplotlib-plots-to-latex} Za grafe z veliko točkami (\textgreater10000) pa je bolje uporabiti \texttt{.png}, sicer lahko stavljenje dokumenta z LaTeXom traja več minut.
\item
