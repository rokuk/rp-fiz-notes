...
\subsection*{Crash Course Computer Science}\label{crash-course-computer-science}}
\addcontentsline{toc}{subsection}{Crash Course Computer Science}
...
\subsection*{Posamezne teme}\label{posamezne-teme}}
\addcontentsline{toc}{subsection}{Posamezne teme}

Spodaj je navedenih nekaj tem o delovanju računalnika. Predlagam ogled v takem vrstnem redu:

\hypertarget{computer-basics---what-is-inside-a-computer}{%
\subsubsection*{Computer basics - What is inside a computer?}\label{computer-basics---what-is-inside-a-computer}}
\addcontentsline{toc}{subsubsection}{Computer basics - What is inside a computer?}

Komponente računalnika. Osnovno - lahko preskočite.
\url{https://www.youtube.com/watch?v=HB4I2CgkcCo}

\hypertarget{sebastian-lague---exploring-how-computers-work}{%
\subsubsection*{Sebastian Lague - Exploring How Computers Work}\label{sebastian-lague---exploring-how-computers-work}}
\addcontentsline{toc}{subsubsection}{Sebastian Lague - Exploring How Computers Work}
...
\hypertarget{tom-scott---whats-your-computer-actually-doing}{%
\subsubsection*{Tom Scott - What's Your Computer Actually Doing?}\label{tom-scott---whats-your-computer-actually-doing}}
\addcontentsline{toc}{subsubsection}{Tom Scott - What's Your Computer Actually Doing?}

Poenostavljen opis kako računalniški procesor dejansko izvaja naše programe.
\url{https://www.youtube.com/watch?v=Z5JC9Ve1sfI}

\hypertarget{how-do-computers-read-code}{%
\subsubsection*{How do computers read code?}\label{how-do-computers-read-code}}
\addcontentsline{toc}{subsubsection}{How do computers read code?}
...
\hypertarget{ben-eater---learn-how-computers-add-numbers-and-build-a-4-bit-adder-circuit}{%
\subsubsection*{Ben Eater - Learn how computers add numbers and build a 4 bit adder circuit}\label{ben-eater---learn-how-computers-add-numbers-and-build-a-4-bit-adder-circuit}}
\addcontentsline{toc}{subsubsection}{Ben Eater - Learn how computers add numbers and build a 4 bit adder circuit}

Razlaga vezja za seštevanje in demonstracija, kako ga sestaviti.
\url{https://www.youtube.com/watch?v=wvJc9CZcvBc}

\hypertarget{sebastian-lague---how-do-computers-remember}{%
\subsubsection*{Sebastian Lague - How Do Computers Remember?}\label{sebastian-lague---how-do-computers-remember}}
\addcontentsline{toc}{subsubsection}{Sebastian Lague - How Do Computers Remember?}

Demonstracija elektronskih vezij, ki lahko shranijo vrednosti.
\url{https://www.youtube.com/watch?v=I0-izyq6q5s\&t=613s}

\hypertarget{dr.-phil-moriarty---physics-of-computer-chips}{%
\subsubsection*{Dr.~Phil Moriarty - Physics of Computer Chips}\label{dr.-phil-moriarty---physics-of-computer-chips}}
\addcontentsline{toc}{subsubsection}{Dr.~Phil Moriarty - Physics of Computer Chips}

Intervju z nanofizikom, ki opiše, kako so narejene komponente procesorja.
\url{https://www.youtube.com/watch?v=xkLAhU74f3s}

\hypertarget{izdelava-ux10dipov}{%
\subsubsection*{Izdelava čipov}\label{izdelava-ux10dipov}}
\addcontentsline{toc}{subsubsection}{Izdelava čipov}

Tole je sicer PR video, a dobro pokaže kompleksnost in proces izdelave čipov.
\url{https://www.youtube.com/watch?v=bor0qLifjz4}

\hypertarget{why-do-computers-use-1s-and-0s}{%
\subsubsection{Why do computers use 1's and 0's?}\label{why-do-computers-use-1s-and-0s}}
...
\hypertarget{izpljani-seznamislovarjimnoux17eice}{%
\section{Izpljani seznami/slovarji/množice}\label{izpljani-seznamislovarjimnoux17eice}}
